package com.techstore.notification.exception;
...
public enum ErrorCode {
    ...
    CANNOT_SEND_EMAIL(1012, "Cannot send email", HttpStatus.INTERNAL_SERVER_ERROR),
    INVALID_OTP(1013, "OTP không hợp lệ hoặc đã hết hạn", HttpStatus.BAD_REQUEST),
    INVALID_USER_TYPE(1014, "Loại người dùng không hợp lệ", HttpStatus.BAD_REQUEST),
    ACCOUNT_INACTIVE(1014, "Tài khoản đã bị vô hiệu hóa", HttpStatus.BAD_REQUEST),
    ;
