...
public enum ErrorCode {
    ...
    REVIEW_NOT_FOUND(3000, "Review not found", HttpStatus.NOT_FOUND),
    REVIEW_ALREADY_EXISTED(3001, "Review already existed for this order detail", HttpStatus.CONFLICT),
    INVALID_RATING(3002, "Rating must be between 1 and 5", HttpStatus.BAD_REQUEST),
    ORDER_NOT_COMPLETED(3003, "Cannot review because order is not completed", HttpStatus.BAD_REQUEST),
    ORDER_DETAIL_NOT_FOUND(3004, "Order detail not found", HttpStatus.NOT_FOUND),
    REVIEW_PERMISSION_DENIED(3005, "You are not allowed to modify this review", HttpStatus.FORBIDDEN),

    REPLY_NOT_FOUND(3010, "Reply not found", HttpStatus.NOT_FOUND),
    REPLY_ALREADY_EXISTED(3011, "This review already has a reply", HttpStatus.CONFLICT),
    REPLY_PERMISSION_DENIED(3012, "You are not allowed to modify this reply", HttpStatus.FORBIDDEN),

    PRODUCT_SERVICE_UNAVAILABLE(3020, "Product service unavailable", HttpStatus.SERVICE_UNAVAILABLE),
    ORDER_SERVICE_UNAVAILABLE(3021, "Order service unavailable", HttpStatus.SERVICE_UNAVAILABLE),

    INVALID_REVIEW_STATUS(3030, "Invalid review status", HttpStatus.BAD_REQUEST),
    REVIEW_ALREADY_DELETED(3031, "Review already deleted", HttpStatus.BAD_REQUEST),
    REPLY_ALREADY_DELETED(3032, "Reply already deleted", HttpStatus.BAD_REQUEST),
    ;
