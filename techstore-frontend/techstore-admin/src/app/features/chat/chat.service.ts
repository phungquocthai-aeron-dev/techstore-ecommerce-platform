...
export class AdminChatService {
  ...
  createConversation(req: ConversationRequest): Observable<ApiResponse<ConversationResponse>> {
  ...
  sendMessage(req: ChatMessageRequest): Observable<ApiResponse<ChatMessageResponse>> {
  ...
  getMessages(conversationId: string, userType: string): Observable<ApiResponse<ChatMessageResponse[]>> {
